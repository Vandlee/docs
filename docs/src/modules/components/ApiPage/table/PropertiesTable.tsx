        ...
        <StyledTable>
          <thead>
            <tr>
              ...
              <th>{t('api-docs.name')}</th>
              <th>{t('api-docs.type')}</th>
              {hasDefaultColumn && <th>{t('api-docs.default')}</th>}
            ...
            {properties.map((params) => {
              ...
              return (
                <tr key={propName} id={hash}>
                  <td className="uiApi-table-item-title algolia-lvl3">
                    {propName}
                    {isRequired ? '*' : ''}
                    {isOptional ? '?' : ''}
                    {isProPlan && (
                  ...
                  <td className="type-column">
                    {
                      <span
                        className="uiApi-table-item-type"
                        dangerouslySetInnerHTML={{
                          __html: typeName,
                        }}
                      />
                  ...
                  {hasDefaultColumn && (
                    <td className="default-column">
                      {propDefault ? (
                        <span className="uiApi-table-item-default">{propDefault}</span>
                      ) : (
                        '-'
                      )}
                    </td>
                  )}
                  <td className="uiPropTable-description-column algolia-content">
