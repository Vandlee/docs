...
const StyledMarkdownElement = styled(MarkdownElement)(({ theme }) => [
    {
        '& .scrollContainer': {
            ...
            overflow: 'auto',
            marginTop: -1,
            backgroundColor: 'hsl(0, 0%, 10%)', // a special, one-off, color tailored for the code blocks using MUI's branding theme blue palette as the starting point. It has a less saturaded color but still maintaining a bit of the blue tint.
            border: 0,
            colorScheme: 'dark',
            '&:hover': {
