function importMarkdown(lang: string, route: { product: string; path: string }) {
    ...
    try {
      ...
      const markdown = require(`docs/data/${route.product}/${route.path}/${lastSegment}_${lang}.md?u-shiiMarkdown`);
      return markdown;
    } catch (error) {
      ...
      try {
        ...
        const markdown = require(`docs/data/${route.product}/${route.path}/${lastSegment}_es.md?u-shiiMarkdown`);
        return markdown;
      } catch (defaultError) {
