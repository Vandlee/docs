    ...
    return (
        <ThemeProvider theme={(outerTheme) => getTheme('light', outerTheme)}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', py: 2, px: 1}}>
                ...
                >
                    <line y1="-0.5" x2="34.8281" y2="-0.5" transform="matrix(0.775235 0.631673 0.631673 -0.775235 273 3)" stroke="white"/>
                    <line x1="154.5" y1="13" x2="154.5" y2="63" stroke="white"/>
                    <line x1="211.454" y1="13.7894" x2="224.454" y2="41.7894" stroke="white"/>
                    <line x1="88.4851" y1="14.1213" x2="81.4851" y2="42.1213" stroke="white"/>
                    <line y1="-0.5" x2="41.6173" y2="-0.5" transform="matrix(-0.816968 0.576683 0.576683 0.816968 35 1)" stroke="white"/>
                    <path d="M46.7457 17.2479C48.5168 15.8029 53.4529 16.7909 53.4529 16.7909C53.4529 16.7909 48.9587 14.9704 47.9006 12.5887C46.8425 10.2069 47.2787 6.54709 47.2787 6.54709C47.2787 6.54709 46.5637 9.43134 43.4633 11.4888C40.3628 13.5462 37.0348 12.7213 37.0348 12.7213C37.0348 12.7213 40.5847 13.6012 42.3084 16.1479C44.0321 18.6947 43.209 22.9651 43.209 22.9651C43.209 22.9651 44.9745 18.6928 46.7457 17.2479Z" stroke="white"/>
                    <path d="M254.726 15.2741C255.631 13.1751 260.466 11.7749 260.466 11.7749C260.466 11.7749 255.639 12.2327 253.601 10.6075C251.564 8.98235 250.263 5.53392 250.263 5.53392C250.263 5.53392 250.959 8.42278 249.157 11.6784C247.355 14.934 244.022 15.7372 244.022 15.7372C244.022 15.7372 247.577 14.8805 250.281 16.345C252.985 17.8096 254.225 21.9782 254.225 21.9782C254.225 21.9782 253.821 17.3732 254.726 15.2741Z" stroke="white"/>
                </svg>
            </Box>
        </ThemeProvider>
    )
