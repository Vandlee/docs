...
async function run(argv) {
  ...
  const env = {
    NODE_ENV: 'production',
    BABEL_ENV: bundle,
    YUSHII_BUILD_VERBOSE: verbose,
    YUSHII_BABEL_RUNTIME_VERSION: babelRuntimeVersion,
  ...
  const outDir = path.resolve(
    ...
    // 1. `import ArrowDownIcon from '@yushii/icons-material/ArrowDown'`.
    // 2. `import Typography from '@yushii/material/Typography'`.
