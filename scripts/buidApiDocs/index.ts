...
import { ProjectSettings, buildApi } from '@vandlee-internal/api-docs-builder';
import {
  uUiProjectSettings,
} from '@vandlee-internal/api-docs-builder-core';
...
yargs(process.argv.slice(2))
  .command({
    command: '$0',
    describe: 'Generates API documentation for the Vandlee packages.',
    builder: (command) => {
      return command
        .option('grep', {
          description:
