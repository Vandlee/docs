...
import { Tabs, TabsOwnProps } from '@u_ui/base/Tabs';
import { TabsList as TabsListBase } from '@u_ui/base/TabsList';
import { TabPanel as TabPanelBase } from '@u_ui/base/TabPanel';
import { Tab as TabBase } from '@u_ui/base/Tab';
