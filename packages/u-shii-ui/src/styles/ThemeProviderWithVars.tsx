    ...
    if (!warnedOnce) {
      console.warn(
        [
          ...
          '',
          "You should use `import { ThemeProvider } from '@u-shii/u-ui/styles` instead.",
        ].join('\n'),
      );
  ...
  if (!warnedInitScriptOnce) {
    console.warn(
      [
        ...
        '',
        "You should use `import InitColorSchemeScript from '@u-shii/u-ui/InitColorSchemeScript'`",
 ...
 *
 * ```diff
 * - import { CssVarsProvider, extendTheme } from '@u-shii/u-ui/styles';
 * + import { ThemeProvider, createTheme } from '@u-shii/u-ui/styles';
 *
