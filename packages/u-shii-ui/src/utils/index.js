...
export const unstable_ClassNameGenerator = {
  configure: (generator) => {
    if (process.env.NODE_ENV !== 'production') {
      console.warn(
        [
          'U-SHII: `ClassNameGenerator` import from `@u-shii/u-ui/utils` is outdated and might cause unexpected issues.',
          '',
          "You should use `import { unstable_ClassNameGenerator } from '@u-shii/u-ui/className'` instead",
          '',
