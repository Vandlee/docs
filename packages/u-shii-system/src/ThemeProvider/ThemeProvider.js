...
import { ThemeContext as StyledEngineThemeContext } from '@u-shii/styled-engine';
...
function ThemeProvider(props) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    if (
      ...
      console.error(
        [
          'U-SHII: You are providing a theme function prop to the ThemeProvider component:',
  ...
  return (
    <UshiiThemeProvider theme={privateTheme}>
