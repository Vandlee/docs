...
import { UshiiCancellableEventHandler } from '../utils/u-shiiCancellableEvent';
...
interface UseSelectButtonSlotEventHandlers {
  onMouseDown: UshiiCancellableEventHandler<React.MouseEvent>;
}
...
interface UseSelectHiddenInputSlotEventHandlers {
  onChange: UshiiCancellableEventHandler<React.ChangeEvent<HTMLInputElement>>;
}
...
interface UseSelectListboxSlotEventHandlers {
  onBlur: UshiiCancellableEventHandler<React.FocusEvent<HTMLElement>>;
}
