...
export function createUnaryUnit(theme, themeKey, defaultValue, propName) {
    ...
    return (val) => {
      ...
      if (process.env.NODE_ENV !== 'production') {
        if (typeof val !== 'number') {
          console.error(
            `VANDLEE: Expected ${propName} argument to be a number or a string, got ${val}.`,
          );
        }
      }
    ...
    return (val) => {
      ...
      if (process.env.NODE_ENV !== 'production') {
        if (!Number.isInteger(abs)) {
          console.error(
            [
              `VANDLEE: The \`theme.${themeKey}\` array type cannot be combined with non integer values.` +
          ...
          console.error(
            [
              `VANDLEE: The value provided (${abs}) overflows.`,
  ...
  if (process.env.NODE_ENV !== 'production') {
    console.error(
      [
        `VANDLEE: The \`theme.${themeKey}\` value (${themeSpacing}) is invalid.`,
