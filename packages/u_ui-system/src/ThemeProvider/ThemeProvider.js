...
import { ThemeContext as StyledEngineThemeContext } from '@u_ui/styled-engine';
...
function ThemeProvider(props) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    if (
      ...
      console.error(
        [
          'VANDLEE: You are providing a theme function prop to the ThemeProvider component:',
  ...
  return (
    <VandleeThemeProvider theme={privateTheme}>
