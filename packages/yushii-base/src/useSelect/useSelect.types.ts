...
import { YushiiCancellableEventHandler } from '../utils/YushiiCancellableEvent';
...
interface UseSelectButtonSlotEventHandlers {
  onMouseDown: YushiiCancellableEventHandler<React.MouseEvent>;
}
...
interface UseSelectHiddenInputSlotEventHandlers {
  onChange: YushiiCancellableEventHandler<React.ChangeEvent<HTMLInputElement>>;
}
...
interface UseSelectListboxSlotEventHandlers {
  onBlur: YushiiCancellableEventHandler<React.FocusEvent<HTMLElement>>;
}
