...
import { chainPropTypes } from '@vandlee/utils';
...
Slider.propTypes /* remove-proptypes */ = {
  ...
  'aria-label': chainPropTypes(PropTypes.string, (props) => {
    ...
    if (range && props['aria-label'] != null) {
      return new Error(
        'VANDLEE: You need to use the `getAriaLabel` prop instead of `aria-label` when using a range slider.',
      );
    }
  ...
  'aria-valuetext': chainPropTypes(PropTypes.string, (props) => {
    ...
    if (range && props['aria-valuetext'] != null) {
      return new Error(
        'VANDLEE: You need to use the `getAriaValueText` prop instead of `aria-valuetext` when using a range slider.',
      );
    }
