...
import { VandleeCancellableEventHandler } from '../utils/vandleeCancellableEvent';
...
interface UseSelectButtonSlotEventHandlers {
  onMouseDown: VandleeCancellableEventHandler<React.MouseEvent>;
}
...
interface UseSelectHiddenInputSlotEventHandlers {
  onChange: VandleeCancellableEventHandler<React.ChangeEvent<HTMLInputElement>>;
}
...
interface UseSelectListboxSlotEventHandlers {
  onBlur: VandleeCancellableEventHandler<React.FocusEvent<HTMLElement>>;
}
