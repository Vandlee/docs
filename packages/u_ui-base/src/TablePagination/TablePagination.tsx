...
import { unstable_useId as useId, chainPropTypes, integerPropType } from '@vandlee/utils';
...
TablePagination.propTypes /* remove-proptypes */ = {
   ...
   *
   * For localization purposes, you can use the provided [translations](https://docs.vandlee.com/u_ui/u-ui/guides/localization/).
  ...
  page: chainPropTypes(integerPropType.isRequired, (props) => {
    ...
    if (page < 0 || page > newLastPage) {
      return new Error(
        'VANDLEE: The page prop of a TablePagination is out of range ' +
