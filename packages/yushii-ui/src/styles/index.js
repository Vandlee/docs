...
export { unstable_createBreakpoints } from '@yushii/system/createBreakpoints';
// TODO: Remove this function in v6.
// eslint-disable-next-line @typescript-eslint/naming-convention
export function experimental_sx() {
  throw /* minify-error */ new Error(
    'Yushii: The `experimental_sx` has been moved to `theme.unstable_sx`.' +
      'For more details, see https://github.com/mui/material-ui/pull/35150.',
  );
}
export { default as createTheme, createYushiiTheme } from './createTheme';
...
export { StyledEngineProvider } from '@yushii/system';
// The legacy utilities from @yushii/styles
