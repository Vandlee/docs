...
import { DefaultTheme } from '@yushii/system';
...
export default function ThemeProvider<Theme = DefaultTheme>({
  ...
  const yushiiTheme = (THEME_ID in theme ? theme[THEME_ID] : theme) as ThemeProviderProps['theme'];
  if (!('colorSchemes' in yushiiTheme)) {
    return <ThemeProviderNoVars theme={theme} {...props} />;
  }
