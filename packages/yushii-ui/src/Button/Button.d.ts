...
export interface ButtonOwnProps {
   ...
   * @default 'center'
   */
  justify?: OverridableStringUnion<'center' | 'start' | 'end'>;
  /**
  ...
  /**
   * If `true`, the icon animation will be disabled.
   * @default false
   */
  ...
  /**
   * If `true`, the button radius will be rounded.
   * @default false
   */
  isRadius?: boolean;
}
 ...
 * chan make extension quite tricky
 */
