...
const Button = React.forwardRef(function Button(inProps, ref) {
  ...
  const props = useDefaultProps({ props: resolvedProps, name: 'YushiiButton' });
  const {
    children,
    color = 'primary',
    component = 'button',
...
Button.propTypes /* remove-proptypes */ = {
  ...
  color: PropTypes /* @typescript-to-proptypes-ignore */.oneOfType([
    PropTypes.oneOf(['inherit', 'primary', 'secondary', 'accent', 'neutral', 'success', 'error', 'info', 'warning']),
    PropTypes.string,
  ]),
  /**
   ...
   * to highlight the element by applying separate styles with the `.Yushii-focusVisible` class.
   * @default false
   */
