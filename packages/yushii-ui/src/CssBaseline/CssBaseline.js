...
export const styles = (theme, enableColorScheme = false) => {
  ...
  const themeOverrides = theme.components?.YushiiCssBaseline?.styleOverrides;
  if (themeOverrides) {
...
function CssBaseline(inProps) {
  const props = useDefaultProps({ props: inProps, name: 'YushiiCssBaseline' });
