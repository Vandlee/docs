...
import getValidReactChildren from '@yushii/utils/getValidReactChildren';
...
const ToggleButtonGroup = React.forwardRef(function ToggleButtonGroup(inProps, ref) {
    const props = useDefaultProps({ props: inProps, name: 'YushiiToggleButtonGroup' });
    const {
        children,
        className,
        color = 'standard',
