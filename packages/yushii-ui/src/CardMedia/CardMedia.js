...
const CardMedia = React.forwardRef(function CardMedia(inProps, ref) {
  const props = useDefaultProps({ props: inProps, name: 'YushiiCardMedia' });
...
CardMedia.propTypes /* remove-proptypes */ = {
  ...
  children: chainPropTypes(PropTypes.node, (props) => {
    if (!props.children && !props.image && !props.src && !props.component) {
      return new Error(
        'YUSHII: Either `children`, `image`, `src` or `component` prop must be specified.',
      );
    }
    return null;
  }),
