...
import { createGrid as createGrid2 } from '@yushii/system/Grid';
import { SxProps, SystemProps } from '@yushii/system';
...
export interface GridBaseProps {
  ...
  const Grid2 = createGrid2({
    ...
    componentName: 'YushiiGrid2',
    useThemeProps: (inProps) => useDefaultProps({ props: inProps, name: 'YushiiGrid2' }),
    useTheme,
