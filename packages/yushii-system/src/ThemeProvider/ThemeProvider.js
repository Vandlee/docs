...
import { ThemeContext as StyledEngineThemeContext } from '@yushii/styled-engine';
...
function ThemeProvider(props) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    if (
      ...
      console.error(
        [
          'Yushii: You are providing a theme function prop to the ThemeProvider component:',
  ...
  return (
    <YushiiThemeProvider theme={privateTheme}>
