...
import isYushiiElement from '@yushii/utils/isYushiiElement';
...
import { CreateYushiiStyled } from '../createStyled';
import { GridTypeMap, GridOwnerState, GridProps, GridOffset, GridSize } from './GridProps';

const defaultTheme = createTheme();

// widening Theme to any so that the consumer can own the theme structure.
const defaultCreateStyledComponent = (systemStyled as CreateYushiiStyled<any>)('div', {
  name: 'YushiiGrid',
  slot: 'Root',
