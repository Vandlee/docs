...
import { Interpolation, YushiiStyledComponent as StyledComponent } from '@yushii/styled-engine';
...
const useThemePropsDefault = (inProps: ContainerProps) =>
  useThemePropsSystem({ props: inProps, name: 'YushiiContainer', defaultTheme });
