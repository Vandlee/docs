 ...
 * that exist outside the DOM hierarchy of the parent compoentn.
 */

const Portal = React.forwardRef(function Portal(
  props: PortalProps,
  forwaredRef: React.ForwardedRef<Element>,
) {
  ...
  useEnhancedEffect(() => {
    if (mountNode && !disablePortal) {
      setRef(forwaredRef, mountNode);
      return () => {
        setRef(forwaredRef, null);
      };
    }

    return undefined;
  }, [forwaredRef, mountNode, disablePortal]);
