...
export type YushiiStyledComponent<
...
/**
 * For internal usage in `@yushii/system` package
 */
...
export interface CreateYushiiStyled<
  YushiiStyledCommonProps extends {},
  YushiiStyledOptions,
...
> {
  ...
  >(
    component: C,
    options: FilteringStyledOptions<React.ComponentProps<C>, ForwardedProps> & YushiiStyledOptions,
  ): CreateStyledComponent<
    Pick<PropsOf<C>, ForwardedProps> & YushiiStyledCommonProps,
    {},
    {
  ...
  <C extends React.ComponentClass<React.ComponentProps<C>>>(
    component: C,
    options?: StyledOptions<PropsOf<C> & YushiiStyledCommonProps> & YushiiStyledOptions,
  ): CreateStyledComponent<
    PropsOf<C> & YushiiStyledCommonProps,
    {},
    {
      ref?: React.Ref<InstanceType<C>>;
    },
  ...
  >(
    component: C,
    options: FilteringStyledOptions<React.ComponentProps<C>, ForwardedProps> & YushiiStyledOptions,
  ): CreateStyledComponent<Pick<PropsOf<C>, ForwardedProps> & YushiiStyledCommonProps, {}, {}, Theme>;

  <C extends React.JSXElementConstructor<React.ComponentProps<C>>>(
    component: C,
    options?: StyledOptions<PropsOf<C> & YushiiStyledCommonProps> & YushiiStyledOptions,
  ): CreateStyledComponent<PropsOf<C> & YushiiStyledCommonProps, {}, {}, Theme>;
  ...
  <Tag extends keyof React.JSX.IntrinsicElements>(
    tag: Tag,
    options?: StyledOptions<YushiiStyledCommonProps> & YushiiStyledOptions,
  ): CreateStyledComponent<YushiiStyledCommonProps, React.JSX.IntrinsicElements[Tag], {}, Theme>;
}