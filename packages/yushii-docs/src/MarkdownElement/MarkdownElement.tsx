...
const Root = styled('div')(
  ({ theme }) => ({
    ...
    '& pre': {
      ...
      backgroundColor: 'hsl(210, 25%, 9%)', // a special, one-off, color tailored for the code blocks using Yushii's branding theme blue palette as the starting point. It has a less saturaded color but still maintaining a bit of the blue tint.
      color: 'hsl(60, 30%, 96%)',
      colorScheme: 'dark',
      borderRadius: `var(--yushiidocs-shape-borderRadius, ${
    ...
    '& h1': {
      ...
      margin: '10px 0',
      color: `var(--yushiidocs-palette-primaryDark-900, ${lightTheme.palette.primaryDark[900]})`,
      fontWeight: 600,
      letterSpacing: -0.2,
    },
    '& .description': {
    ...
    '& h2': {
      ...
      color: `var(--yushiidocs-palette-grey-900, ${lightTheme.palette.grey[900]})`,
      margin: '40px 0 4px',
    },
    '& h3': {
    ...
    '& h1, & h2, & h3, & h4': {
      ...
      '& .anchor-icon, & .comment-link': {
        ...
        height: 26,
        width: 26,
        color: `var(--yushiidocs-palette-grey-600, ${lightTheme.palette.grey[600]})`,
        ...
        '&:hover': {
          ...
          color: `var(--yushiidocs-palette-primary-main, ${lightTheme.palette.primary.main})`,
        },
        '& svg': {
          height: 14,
          width: 14,
    ...
    '& table': {
      ...
      '& .prop-default, & .slot-default': {
        borderBottom: `1px dotted var(--yushiidocs-palette-divider, ${lightTheme.palette.divider})`,
      },
    },
    '& td': {
      ...theme.typography.body2,
      borderBottom: `1px solid var(--yushiidocs-palette-divider, ${lightTheme.palette.divider})`,
      paddingRight: 20,
      paddingTop: 16,
      paddingBottom: 16,
      color: `var(--yushiidocs-palette-text-secondary, ${lightTheme.palette.text.secondary})`,
    },
    '& td code': {
      lineHeight: 1.6,
    },
    ...
    '& blockquote': {
      ...
      '&::before': {
        ...
        content: '"“"',
        color: `var(--yushiidocs-palette-grey-300, ${lightTheme.palette.grey[300]})`,
        fontSize: '2.5rem',
        top: 8,
        marginLeft: -6,
        lineHeight: 0.5,
    ...
    '& .YushiiCallout-root': {
      ...
      border: '1px solid',
      color: `var(--yushiidocs-palette-text-secondary, ${lightTheme.palette.text.secondary})`,
      borderColor: `var(--yushiidocs-palette-grey-100, ${lightTheme.palette.grey[100]})`,
      borderRadius: `var(--yushiidocs-shape-borderRadius, ${
        theme.shape?.borderRadius ?? lightTheme.shape.borderRadius
      }px)`,
      '& .YushiiCallout-content': {
        minWidth: 0, // Allows content to shrink. Useful when callout contains code block
        flexGrow: 1,
      },
      '& code': {
        height: 'fit-content',
        backgroundColor: `var(--yushiidocs-palette-grey-100, ${lightTheme.palette.grey[100]})`,
        borderColor: `var(--yushiidocs-palette-grey-300, ${lightTheme.palette.grey[300]})`,
      },
      '& p': {
        fontWeight: 400,
        marginBottom: '8px',
      ...
      '&.YushiiCallout-error': {
        color: `var(--yushiidocs-palette-error-900, ${lightTheme.palette.error[900]})`,
        backgroundColor: `var(--yushiidocs-palette-error-50, ${lightTheme.palette.error[50]})`,
        borderColor: `var(--yushiidocs-palette-error-100, ${lightTheme.palette.error[100]})`,
        '& strong': {
          color: `var(--yushiidocs-palette-error-800, ${lightTheme.palette.error[800]})`,
        },
        '& svg': {
          fill: `var(--yushiidocs-palette-error-500, ${lightTheme.palette.error[600]})`,
        },
        '& a': {
          color: `var(--yushiidocs-palette-error-800, ${lightTheme.palette.error[800]})`,
      ...
      '&.YushiiCallout-info': {
        ...
        borderColor: `var(--yushiidocs-palette-grey-100, ${lightTheme.palette.grey[100]})`,
        '& strong': {
          color: `var(--yushiidocs-palette-primary-800, ${lightTheme.palette.primary[800]})`,
        },
        '& svg': {
          fill: `var(--yushiidocs-palette-grey-600, ${lightTheme.palette.grey[600]})`,
        },
      },
      '&.YushiiCallout-success': {
        color: `var(--yushiidocs-palette-success-900, ${lightTheme.palette.success[900]})`,
        backgroundColor: `var(--yushiidocs-palette-success-50, ${lightTheme.palette.success[50]})`,
        borderColor: `var(--yushiidocs-palette-success-100, ${lightTheme.palette.success[100]})`,
        '& strong': {
          color: `var(--yushiidocs-palette-success-900, ${lightTheme.palette.success[900]})`,
        },
        '& svg': {
          fill: `var(--yushiidocs-palette-success-600, ${lightTheme.palette.success[600]})`,
        },
        '& a': {
          color: `var(--yushiidocs-palette-success-900, ${lightTheme.palette.success[900]})`,
      ...
      '&.YushiiCallout-warning': {
        color: `var(--yushiidocs-palette-grey-900, ${lightTheme.palette.grey[900]})`,
        backgroundColor: alpha(lightTheme.palette.warning[50], 0.5),
        borderColor: alpha(lightTheme.palette.warning[700], 0.15),
        '& strong': {
          color: `var(--yushiidocs-palette-warning-800, ${lightTheme.palette.warning[800]})`,
        },
        '& svg': {
          fill: `var(--yushiidocs-palette-warning-600, ${lightTheme.palette.warning[600]})`,
        },
        '& a': {
          color: `var(--yushiidocs-palette-warning-800, ${lightTheme.palette.warning[800]})`,
    ...
    '& hr': {
      ...
      border: 0,
      flexShrink: 0,
      backgroundColor: `var(--yushiidocs-palette-divider, ${lightTheme.palette.divider})`,
    },
    '& kbd.key': {
      padding: 6,
      display: 'inline-block',
      ...
      verticalAlign: 'middle',
      borderRadius: 6,
      border: `1px solid var(--yushiidocs-palette-grey-300, ${lightTheme.palette.grey[300]})`,
      backgroundColor: `var(--yushiidocs-palette-grey-50, ${lightTheme.palette.grey[50]})`,
      boxShadow: `inset 0 -2px 0 var(--yushiidocs-palette-grey-200, ${lightTheme.palette.grey[200]})`,
    },
    '& details': {
      width: '100%',
    ...
    '& summary': {
      ...
      '&:hover': {
        backgroundColor: `var(--yushiidocs-palette-grey-100, ${lightTheme.palette.grey[50]})`,
      },
    },
    ...
    '& .YushiiCode-root': {
      ...
      fontSize: 10,
      '&:has(.YushiiCode-title)': {
        margin: theme.spacing(2, 'auto'),
        border: `1px solid var(--yushiidocs-palette-primaryDark-700, ${lightTheme.palette.primaryDark[700]})`,
    ...
    '& .YushiiCode-copy': {
      ...
      '& .YushiiCode-copied-label': {
        display: 'none',
      },
      '&:hover, &:focus': {
        borderColor: `var(--yushiidocs-palette-primaryDark-400, ${lightTheme.palette.primaryDark[400]})`,
        backgroundColor: `var(--yushiidocs-palette-primaryDark-700, ${lightTheme.palette.primaryDark[700]})`,
        color: '#FFF',
        '& .YushiiCode-copyKeypress': {
          display: 'block',
    ...
    '& .YushiiCode-title': {
      ...
      borderBottom: `1px solid var(--yushiidocs-palette-primaryDark-700, ${lightTheme.palette.primaryDark[700]})`,
      backgroundColor: `var(--yushiidocs-palette-primaryDark-900, ${lightTheme.palette.primaryDark[900]})`,
      fontFamily: theme.typography.fontFamilyCode,
      fontSize: theme.typography.pxToRem(12),
      fontWeight: theme.typography.fontWeightBold,
      color: `var(--yushiidocs-palette-grey-200, ${lightTheme.palette.grey[200]})`,
      '::before': {
  ...
  ({ theme }) => ({
    [`:where(${theme.vars ? '[data-yushii-color-scheme="dark"]' : '.mode-dark'}) &`]: {
      ...
      '& strong': {
        color: `var(--yushiidocs-palette-grey-200, ${darkTheme.palette.grey[200]})`,
      },
      '& hr': {
        backgroundColor: `var(--yushiidocs-palette-divider, ${darkTheme.palette.divider})`,
      },
      '& a': {
        color: `var(--yushiidocs-palette-primary-300, ${darkTheme.palette.primary[300]})`,
      },
      '& a code': {
        color: `var(--yushiidocs-palette-primary-light, ${darkTheme.palette.primary.light})`,
      },
      '& h1, & h2, & h3, & h4, & h5': {
        color: `var(--yushiidocs-palette-grey-50, ${darkTheme.palette.grey[50]})`,
        '& .anchor-icon, & .comment-link': {
          color: `var(--yushiidocs-palette-primary-300, ${darkTheme.palette.primaryDark[400]})`,
          '&:hover': {
            color: `var(--yushiidocs-palette-primary-100, ${darkTheme.palette.primary[100]})`,
      ...
      '& p, & ul, & ol': {
        color: `var(--yushiidocs-palette-grey-400, ${darkTheme.palette.grey[400]})`,
      },
      '& h1 code, & h2 code, & h3 code': {
        color: `var(--yushiidocs-palette-grey-100, ${darkTheme.palette.grey[100]})`,
      },
      '& table': {
        '& .required': {
          color: '#a5ffa5',
      ...
      '& td': {
        color: `var(--yushiidocs-palette-text-secondary, ${darkTheme.palette.text.secondary})`,
        borderColor: `var(--yushiidocs-palette-divider, ${darkTheme.palette.divider})`,
      },
      '& th': {
        color: `var(--yushiidocs-palette-text-primary, ${darkTheme.palette.text.primary})`,
      ...
      '& blockquote': {
        borderColor: `var(--yushiidocs-palette-primaryDark-700, ${darkTheme.palette.primaryDark[700]})`,
        '&::before': {
          color: `var(--yushiidocs-palette-primaryDark-500, ${darkTheme.palette.primaryDark[500]})`,
        },
      },
      '& .YushiiCallout-root': {
        borderColor: `var(--yushiidocs-palette-primaryDark-700, ${darkTheme.palette.primaryDark[700]})`,
        '& code': {
          backgroundColor: `var(--yushiidocs-palette-primaryDark-600, ${darkTheme.palette.primaryDark[600]})`,
          borderColor: `var(--yushiidocs-palette-primaryDark-500, ${darkTheme.palette.primaryDark[500]})`,
        },
        '&.YushiiCallout-error': {
          color: `var(--yushiidocs-palette-error-50, ${darkTheme.palette.error[50]})`,
          backgroundColor: alpha(darkTheme.palette.error[700], 0.15),
          borderColor: alpha(darkTheme.palette.error[400], 0.1),
          '& strong': {
            color: `var(--yushiidocs-palette-error-300, ${darkTheme.palette.error[300]})`,
          },
          '& svg': {
            fill: `var(--yushiidocs-palette-error-500, ${darkTheme.palette.error[500]})`,
          },
          '& a': {
            color: `var(--yushiidocs-palette-error-200, ${darkTheme.palette.error[200]})`,
          },
        },
        '&.YushiiCallout-info': {
          color: `var(--yushiidocs-palette-grey-50, ${darkTheme.palette.grey[50]})`,
          ...
          '& svg': {
            fill: `var(--yushiidocs-palette-grey-400, ${darkTheme.palette.grey[400]})`,
          },
        },
        '&.YushiiCallout-success': {
          color: `var(--yushiidocs-palette-success-50, ${darkTheme.palette.success[50]})`,
          backgroundColor: alpha(darkTheme.palette.success[700], 0.12),
          borderColor: alpha(lightTheme.palette.success[400], 0.1),
          '& strong': {
            color: `var(--yushiidocs-palette-success-200, ${darkTheme.palette.success[200]})`,
          },
          '& svg': {
            fill: `var(--yushiidocs-palette-success-500, ${darkTheme.palette.success[500]})`,
          },
          '& a': {
            color: `var(--yushiidocs-palette-success-100, ${darkTheme.palette.success[100]})`,
          },
        },
        '&.YushiiCallout-warning': {
          color: `var(--yushiidocs-palette-warning-50, ${darkTheme.palette.warning[50]})`,
          backgroundColor: alpha(darkTheme.palette.warning[700], 0.12),
          borderColor: alpha(darkTheme.palette.warning[400], 0.1),
          '& strong': {
            color: `var(--yushiidocs-palette-warning-200, ${darkTheme.palette.warning[200]})`,
          },
          '& svg': {
            fill: `var(--yushiidocs-palette-warning-400, ${darkTheme.palette.warning[400]})`,
          },
          '& a': {
            color: `var(--yushiidocs-palette-warning-100, ${darkTheme.palette.warning[100]})`,
          },
        },
      },
      '& kbd.key': {
        color: `var(--yushiidocs-palette-text-primary, ${darkTheme.palette.text.primary})`,
        backgroundColor: `var(--yushiidocs-palette-primaryDark-800, ${darkTheme.palette.primaryDark[800]})`,
        border: `1px solid var(--yushiidocs-palette-primaryDark-600, ${darkTheme.palette.primaryDark[600]})`,
        boxShadow: `inset 0 -2px 0 var(--yushiidocs-palette-primaryDark-700, ${darkTheme.palette.primaryDark[700]})`,
      },
      '& details': {
        borderColor: `var(--yushiidocs-palette-divider, ${darkTheme.palette.divider})`,
      },
