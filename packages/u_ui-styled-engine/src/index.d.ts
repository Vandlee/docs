...
export type VandleeStyledComponent<
...
/**
 * For internal usage in `@u_ui/system` package
 */
...
export interface CreateVandleeStyled<
  VandleeStyledCommonProps extends {},
  VandleeStyledOptions,
...
> {
  ...
  >(
    component: C,
    options: FilteringStyledOptions<React.ComponentProps<C>, ForwardedProps> & VandleeStyledOptions,
  ): CreateStyledComponent<
    Pick<PropsOf<C>, ForwardedProps> & VandleeStyledCommonProps,
    {},
    {
  ...
  <C extends React.ComponentClass<React.ComponentProps<C>>>(
    component: C,
    options?: StyledOptions<PropsOf<C> & VandleeStyledCommonProps> & VandleeStyledOptions,
  ): CreateStyledComponent<
    PropsOf<C> & VandleeStyledCommonProps,
    {},
    {
      ref?: React.Ref<InstanceType<C>>;
    },
  ...
  >(
    component: C,
    options: FilteringStyledOptions<React.ComponentProps<C>, ForwardedProps> & VandleeStyledOptions,
  ): CreateStyledComponent<Pick<PropsOf<C>, ForwardedProps> & VandleeStyledCommonProps, {}, {}, Theme>;

  <C extends React.JSXElementConstructor<React.ComponentProps<C>>>(
    component: C,
    options?: StyledOptions<PropsOf<C> & VandleeStyledCommonProps> & VandleeStyledOptions,
  ): CreateStyledComponent<PropsOf<C> & VandleeStyledCommonProps, {}, {}, Theme>;
  ...
  <Tag extends keyof React.JSX.IntrinsicElements>(
    tag: Tag,
    options?: StyledOptions<VandleeStyledCommonProps> & VandleeStyledOptions,
  ): CreateStyledComponent<VandleeStyledCommonProps, React.JSX.IntrinsicElements[Tag], {}, Theme>;
}