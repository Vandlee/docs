...
export type UshiiStyledComponent<
...
/**
 * For internal usage in `@u-shii/system` package
 */
...
export interface CreateUshiiStyled<
  UshiiStyledCommonProps extends {},
  UshiiStyledOptions,
...
> {
  ...
  >(
    component: C,
    options: FilteringStyledOptions<React.ComponentProps<C>, ForwardedProps> & UshiiStyledOptions,
  ): CreateStyledComponent<
    Pick<PropsOf<C>, ForwardedProps> & UshiiStyledCommonProps,
    {},
    {
  ...
  <C extends React.ComponentClass<React.ComponentProps<C>>>(
    component: C,
    options?: StyledOptions<PropsOf<C> & UshiiStyledCommonProps> & UshiiStyledOptions,
  ): CreateStyledComponent<
    PropsOf<C> & UshiiStyledCommonProps,
    {},
    {
      ref?: React.Ref<InstanceType<C>>;
    },
  ...
  >(
    component: C,
    options: FilteringStyledOptions<React.ComponentProps<C>, ForwardedProps> & UshiiStyledOptions,
  ): CreateStyledComponent<Pick<PropsOf<C>, ForwardedProps> & UshiiStyledCommonProps, {}, {}, Theme>;

  <C extends React.JSXElementConstructor<React.ComponentProps<C>>>(
    component: C,
    options?: StyledOptions<PropsOf<C> & UshiiStyledCommonProps> & UshiiStyledOptions,
  ): CreateStyledComponent<PropsOf<C> & UshiiStyledCommonProps, {}, {}, Theme>;
  ...
  <Tag extends keyof React.JSX.IntrinsicElements>(
    tag: Tag,
    options?: StyledOptions<UshiiStyledCommonProps> & UshiiStyledOptions,
  ): CreateStyledComponent<UshiiStyledCommonProps, React.JSX.IntrinsicElements[Tag], {}, Theme>;
}